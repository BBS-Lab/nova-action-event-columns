...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    public function boot(): void
    {
        ...
        // App-side activation: swap Nova's action Resource (and, through it, the
        // action-event model) for the package's, so both write paths flow through
        // our column-filling ActionEvent. This mirrors the README instructions.
        config(['nova.actions.resource' => ActionResource::class]);
    }
